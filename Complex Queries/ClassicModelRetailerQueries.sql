-- This repository contains a set of queries performed on the ClassicModel Database. The queries showcase my skills in SQL for performing data extraction, aggregation, and business analysis. The ClassicModel is a retailer of scale models of classic cars database. It's a richly structured dataset which serves well for the demonstration of SQL queries.
